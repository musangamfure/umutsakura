...
const tabs = [
  {
    ...
    images: [
      { title: 'Decoration', picture: '/assets/decoration.jpg' },
      { title: 'Cattering', picture: '/assets/reception.jpg' },
      { title: 'Photos', picture: '/assets/men.jpg' },
      { title: 'Videos', picture: '/assets/decoration.jpg' },
      { title: 'Dressing', picture: '/assets/bride.jpg' },
      { title: 'Bouquet', picture: '/assets/RunningDoodle.svg' },
    ],
...
const VendorSection = () => {
  ...
  return (
    <>
      <div className='flex flex-col  pt-20 xl:py-10 items-center justify-center'>
        <div className='text-3xl xl:text-5xl font-medium justify-center items-center flex'>
          Tuguha Ibikenewe Byose mu Birori Byawe
        </div>
                ...
                {index === 0 && tab.images && (
                  <div className=''>
                    <Image
                      ...
                      width={500}
                      height={500}
                      className='flex justify-center my-10 xl:my-6 rounded-xl mx-auto'
                    />
                        ...
                        <div
                          ...
                          className={`${
                            index === activeImageIndex
                              ? 'rounded-md bg-[#dbd9d9] items-center justify-center flex p-2 cursor-pointer '
        ...
        >
          &quot;Umutsakura adapts to your needs. It&apos;s as minimal or as
